...
class AppColors {
  ...
  static const Color splashBg = Color.fromARGB(255, 11, 91, 15);
  ...
  static const Color textGray = Color(0xFF857D7D);

  // ── Status Colors ──
  static const Color error = Color(0xFFD32F2F);
  static const Color success = Color(0xFF388E3C);
  static const Color warning = Color(0xFFFCEB15);
  ...
  static const Color border = Color(0xFFE3DDDD);

  // ── Decorative ──
  static const Color gold = Color(0xFFB8873D);
}
